...
public class TestConfig implements CommandLineRunner{//Interace: executa tarefas de inicialização ou configuração antes do processamento de solicitações. 
	...
	public void run(String... args) throws Exception {
		...
		Order o1 = new Order(null, Instant.parse("2024-02-24T10:00:07Z"), u1); 
		Order o2 = new Order(null, Instant.parse("2024-01-30T03:42:10Z"), u2); 
		Order o3 = new Order(null, Instant.parse("2024-02-15T15:21:22Z"), u1);
